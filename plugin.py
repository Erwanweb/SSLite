...
def AlexaAPIstart(APICall):

    cmd = 'sudo /home/pi/script/alexa_remote_control.sh -m Alarme Echo-Principal Echo-Cuisine -ok'
    Domoticz.Debug("Strating Alexa API and activation of multiroom named Alarm")
    os.system(cmd)
