        ...
        if (Devices[9].nValue == 1):
            ...
            if (Devices[9].sValue == "10"):
                if not self.VerificationInFunction:
                    ...
                    self.NextCalledSensorPositionInListForVerification = 0
                    self.CalledPS = 0
                    Domoticz.Debug("Reset of sensor called and next called position in list = '{}' and '{}'".format(CalledSensorPositionInList, NextCalledSensorPositionInList))
                if self.PSControltime + timedelta(seconds = 10) <= now:
                    ...
                    Domoticz.Debug("Quantity of PS Listed : {}".format(SensorsNumbers))
                    ...
                    if CalledSensorPositionInList < SensorsNumbers :
                        ...
                        if NextCalledSensorPositionInList < SensorsNumbers :
                            ...
                            Domoticz.Debug("PS Called with position {} and Idx {} is the last in the list !!! ".format(CalledSensorPositionInList, self.CalledPS))
