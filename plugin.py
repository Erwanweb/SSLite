...
class BasePlugin:
    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 1):
            ...
            if (Devices[1].nValue == 1): #alarm is on
                ...
                if (Devices[1].sValue == "10"): #command off
                    ...
                    Devices[8].Update(nValue=2, sValue="Commande impossible - Protection deja active")
                    if self.Telegram:
                        TelegramAPI("Commande impossible - Protection deja active")
                    if self.Alexa:
                        AlexaAPI(
                            "Commande de la protéction impossible. La protéction déja active. Veuillez dabord la désactiver avant de la ré activer au niveau de protection désiré")
