    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 1):
            ...
            if (Devices[1].sValue == "10"):
                ...
                if self.Alexa:
                    os.system(
                        'sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction. anti intrusion. Desarmée"')
                self.NightNewDetection = False
                self.NightDetection = False
                self.NormalNewDetection = False
                self.NormalDetection = False
            ...
            if (Devices[9].sValue == "10"):
                ...
                if Devices[1].nValue == 1:
                    ...
                    if self.Telegram:
                        TelegramAPI("Protection Desarmee")
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction désarmé"')
                    self.NightNewDetection = False
                    self.NightDetection = False
                    self.NormalNewDetection = False
                    self.NormalDetection = False
                ...
                if self.Armingtempo + timedelta(seconds = self.Armingondelay) <= now:
                    if Devices[2].nValue == 0:
                        ...
                        if self.Softrestartingtime + timedelta(minutes = 5) <= now:
                            ...
                            if self.Alexa:
                                os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Linitialisation est terminée. La surveillance a commencée. La protéction est maintenant active"')
