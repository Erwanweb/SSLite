        ...
        if self.LastCommand + timedelta(seconds=20) <= now: #tempo between 2 commands, also because alexa can send same 2 commands in very short time
            ...
            if (Unit == 1):
                ...
                if (Devices[2].nValue == 1): #alarm is on and armed - timer passed
                    ...
                    if (Devices[1].sValue == "10"): #command off
                        ...
                        if self.Alexa:
                            AlexaAPI("La protéction anti intrusion est esactivée")
            ...
            if (Unit == 9):
                ...
                if (Devices[9].sValue == "10"):
                    ...
                    if self.Alexa:
                        AlexaAPI("Je vérifie les capteurs périmétriques. Je vous informerai des que la vérification sera terminé")
                    time.sleep(5)
                    self.verifPS()
                ...
                if (Devices[9].sValue == "20"):
                    ...
                    if self.Alexa:
                        AlexaAPI("Je vérifie les capteurs de présence. Je vous informerai des que la vérification sera terminé")
                    time.sleep(5)
                    self.verifMS1()
