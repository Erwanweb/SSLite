        ...
        if (Unit == 1):
            ...
            if (Devices[1].sValue != "0"):
                if (Devices[1].sValue == "10"):
                    ...
                    if self.Alexa:
                        AlexaAPI("Commande de la protéction impossible. La protéction déja active. Veuillez dabord la désactiver avant de la ré activer au niveau de protection désiré")
