        ...
        if not self.VerificationInFunction:
            ...
            if CalledSensorPositionInList < SensorsNumbers:
                ...
                if NextCalledSensorPositionInList < SensorsNumbers:
                    self.NextCalledPS = params[NextCalledSensorPositionInList]
                    Domoticz.Debug("Next PS Called will be = {}".format(self.NextCalledPS))
                else:
                    Domoticz.Debug("PS Called with position {} and Idx {} was the last in the PS list !!! ".format(CalledSensorPositionInList, self.CalledPS))
                ...
                if (Devices[9].nValue == 1): #self.VerifPS was called by Verif PS action
                    ...
                    if self.DTtempoPS + timedelta(seconds=60) >= now:  # there is at mini 1 PS that was ON in the past 120 seconds
