...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.MS1_on_since = {}
        self.MS2_on_since = {}
        self.VerifMSDelay = 120  # délai par défaut pour verifMS1/verifMS2
        self.Voice = 0
        self.Sirens = []
        self.DTpreDet = []
        self.DTPerimetral = []
    ...
    def onStart(self):
        ...
        # Utiliser la valeur fournie si >0, sinon 120 s par défaut pour verifMS1/2
        self.VerifMSDelay = self.Detectiondelay if int(self.Detectiondelay) > 0 else 120
