        ...
        if (Unit == 1):
            ...
            if self.AlarmReady :
                ...
                if (Devices[1].sValue != "0"):
                    ...
                    Devices[8].Update(nValue=0, sValue="Armement impossible - Desarmee - Non Pret - Verifier capteurs perimetriques")
                    if self.Telegram:
                        TelegramAPI("Armement impossible - Desarmee - Non Pret - Verifier capteurs perimetriques")
                    if self.Alexa:
                        AlexaAPI("Activation de la protéction impossible. Vérifiez les capteurs périmétrique")
            ...
            if (Devices[9].sValue == "10"):
                ...
                if Devices[1].nValue == 1:
                    ...
                    if self.Telegram:
                        TelegramAPI("Protection Desarmee")
                    if self.Alexa:
                        AlexaAPI("Protéction anti intrusion désactivée")
                    self.NightNewDetection = False
                    self.NightDetection = False
                    self.NormalNewDetection = False
                    self.NormalDetection = False
                    ...
                    if self.Alexa:
                        AlexaAPI("Désactivation de la Protéction impossible car elle est déjà désactivée")
