    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 1):
            ...
            if (Devices[1].sValue == "10"):
                ...
                if self.Alexa:
                    os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction anti intrusion Desactivée"')
                self.NightNewDetection = False
                self.NightDetection = False
                self.NormalNewDetection = False
                self.NormalDetection = False
            ...
            if self.AlarmReady :
                if (Devices[1].sValue == "20"):
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction périmetrique activée. Initialisation"')
                    self.Armingtempo = datetime.now()
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction mode nuit activée. Initialisation"')
                    self.Armingtempo = datetime.now()
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction totale activée. Initialisation"')
                    self.Armingtempo = datetime.now()
            ...
            if (Devices[9].sValue == "10"):
                ...
                if Devices[1].nValue == 1:
                    ...
                    if self.Telegram:
                        TelegramAPI("Protection Desarmee")
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Protéction anti intrusion désactivée"')
                    self.NightNewDetection = False
                    self.NightDetection = False
                    self.NormalNewDetection = False
                    self.NormalDetection = False
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Désactivation de la Protéction impossible car elle est déjà désactivée"')
                ...
                if self.Armingtempo + timedelta(seconds = self.Armingondelay) <= now:
                    if Devices[2].nValue == 0:
                        ...
                        if self.Softrestartingtime + timedelta(minutes = 5) <= now:
                            ...
                            if self.Alexa:
                                os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Linitialisation de la protéction est terminée et elle est maintenant active."')
                    ...
                    if "Status" in device:
                        ...
                        if device["Status"] == "On":
                            ...
                            if Devices[2].nValue == 1:
                                ...
                                #if self.Alexa:
                                    #os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"--- DETECTION PERIMETRIQUE: '{}'".format(device["Name"])"')
                ...
                if Devices[2].nValue == 1:
                    if Devices[3].nValue == 1:
                        if Devices[6].nValue == 1:
                            ...
                            if self.Alexa:
                                os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Attention. Intrusion périmétrique détéctée. Identification ou action requise "')
                            self.Intrusion = True
                            self.Detectionchangedtime = datetime.now()
        ...
        if self.Softrestartingtime + timedelta(seconds = 60) <= now:  # wait for any detection if domoticz is just restarting;
            ...
            if self.NightDetection:
                if Devices[6].nValue == 1:
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Attention. Intrusion détéctée. groupe 1. Zone nuit. Identification ou action requise "')
                    self.Intrusion = True
                    self.Detectionchangedtime = datetime.now()
        ...
        if self.Softrestartingtime + timedelta(seconds = 60) <= now:  # wait for any detection if domoticz is just restarting;
            ...
            if self.NormalDetection:
                if Devices[6].nValue == 1:
                    ...
                    if self.Alexa:
                        os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Attention. Intrusion détéctée. groupe 2. Zone générale. Identification ou action requise "')
                    self.Intrusion = True
                    self.Detectionchangedtime = datetime.now()
            ...
            if not self.Alarm:
                if self.Alarmondelay == 0:
                    ...
                    if self.Detectionchangedtime + timedelta(seconds = self.Alarmondelay) <= now:
                        ...
                        if self.Alexa:
                            os.system('sudo /home/pi/script/alexa_remote_control.sh -e speak:"Vous ne vous zètes pas identifié dans le délai impartie. Je déclenche lalarme"')
                    else:
