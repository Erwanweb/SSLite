            ...
            if (Unit == 1):
                ...
                if (Devices[2].nValue == 1): #alarm is on and armed - timer passed
                    ...
                    if not self.AlarmLevel == 0 : #alarm is on but in timer on period
                        if self.Telegram:
                            TelegramAPI("Commande activation impossible - Protection deja active et en cours d'initialisation")
                        if self.Alexa:
                            AlexaAPI("Commande dactivation de la protéction impossible. elle est déja active et en cours dinitialisation.")
                        if self.AlarmLevel == 1:
                            Devices[1].Update(nValue=1, sValue="20")
                        if self.AlarmLevel == 2:
                            Devices[1].Update(nValue=1, sValue="30")
                        ...
                        if self.AlarmReady: #alarm is off and ready for arming command
