...
class BasePlugin:
    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if self.LastCommand + timedelta(seconds=10) <= now: #tempo between 2 commands, also because alexa can send same 2 commands in very short time
                ...
                if (Devices[2].nValue == 1): #alarm is on and armed - timer passed
                    ...
                    if not self.AlarmLevel == 0 : #alarm is on but in timer on period
                        ...
                        if (Devices[1].sValue == "10"):
                            ...
                            if self.Alexa:
                                AlexaAPI( "Commande de la protéction impossible. Vérifiez les capteurs périmétriques ou dites Alexa vérifie les capteurs périmetriques")
