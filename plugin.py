        ...
        if (Unit == 1):
            ...
            if (Devices[1].nValue == 1): #alarm is on
                ...
                if (Devices[1].sValue == "10"): #command off
                    ...
                    if self.Alexa:
                        AlexaAPI("Commande dactivation de la protéction impossible car elle est déja active. Veuillez dabord la désactiver avant de la ré activer au niveau de protection désiré")
